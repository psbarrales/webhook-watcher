  ...
  return (
    <>
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-slate-500">Inicia sesión para continuar con tu plataforma.</p>
      </div>
      {auth.error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {auth.isProcessing ? "Iniciando sesión..." : "Iniciar sesión"}
        </button>
      </form>
      ...
      <div className="mt-4 flex flex-col items-center space-y-2">
        <button
          ...
          disabled={auth.isProcessing}
        >
          {auth.isProcessing ? "Conectando..." : "Iniciar sesión con Google"}
        </button>
      </div>
